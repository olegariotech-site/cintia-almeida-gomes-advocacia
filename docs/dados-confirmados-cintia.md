# Dados confirmados — Cíntia Almeida Gomes Advocacia

Atualização recebida em 07/09/2026 para finalização do site.

## Identidade profissional
- Nome informado: Cintia Pereira Allmeida Gomes
- Nome usado atualmente no site: Cíntia Pereira Almeida Gomes
- **Atenção:** confirmar se “Allmeida” com dois L foi apenas erro de digitação antes da publicação final.
- OAB/SP 541.172
- Marca desejada: Cíntia Almeida Gomes - Advocacia

## Localização e atendimento
- Base: Valinhos/SP
- Abrangência presencial desejada: região de Campinas e cidades circunvizinhas
- Atendimento online: Brasil inteiro
- Atendimento presencial: sim
- Atendimento noturno: disponível, no máximo até 21h
- Não divulgar grade fixa de horários neste momento
...
Pós-graduações informadas:
- Direito de Família
- Direito Processual Civil
- Direito Imobiliário

Ênfase profissional desejada:
- locações de imóveis
- assessoria a síndicos
- assessoria a administradoras
- condomínio

## Áreas e demandas prioritárias
### Direito de Família
- divórcio litigioso
- pensão alimentícia
- guarda
...
- Cliente informou que possui novas fotos e irá enviar para seleção final.
